...
let Asian_region=countrydata.filter((element)=> element.region==="Asia");
console.log(Asian_region);


// Question 2. Get all the countries with population less than 2 lakhs using filter function.
let population_less=countrydata.filter((element)=> element.population<200000);
...
let totalpopulation=countrydata.reduce((accumulator,element)=> accumulator+element.population,0);
